 ...
 */
export function padWithDefault<T>(arr: T[], defaultValue: T, padWidth: number): T[] {
...
/** @param {number} n */
export function getDefaultPalette(n: number): number[][] {
...
export function padColors({ colors, channelsVisible }: { colors: number[][], channelsVisible: boolean[] }): number[] {
  /** @type {Color[]} */
